		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Netflix FioriNet",
									"targetURL": "#projectnetflix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectnetflix-display": {
								"semanticObject": "projectnetflix",
								"action": "display",
								"description": "Netflix FioriNet",
								"title": "Netflix FioriNet",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectnetflix",
									"url": sap.ui.require.toUrl("projectnetflix")
								}
							}
						}
					}
